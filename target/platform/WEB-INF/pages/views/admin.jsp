...
<%-- Java Bean --%>
<jsp:useBean id="adminBean" scope="page" class="team06.platform.web.bean.AdminBean" />

<%-- import --%>
<%@ page import="team06.platform.domain.Database" %>
<%@ page import="java.util.List" %>
<%@ page import="team06.platform.domain.AppsInfo" %>
<%@ page import="team06.platform.domain.DBUser" %>
