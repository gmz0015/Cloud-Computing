...
<div class="w3-bar w3-flat-wet-asphalt w3-card w3-large" style="z-index:4">
    ...
    <a href="#" class="w3-bar-item w3-button w3-right" onclick=window.location.href="/platform/login.jsp">Login</a>
    <%
        } else {
    %>
    <%-- login, need to logout --%>
    <a href="#" class="w3-bar-item w3-button w3-right" onclick=window.location.href="/platform/account/logout.jsp">Logout</a>
